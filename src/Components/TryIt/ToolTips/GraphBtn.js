...
class GraphBtn extends Component {
    state = {
        open: false,
    }
                ...
                <ClickAwayListener onClickAway={this.handleTooltipClose}>
                    <div>
                        <Tooltip
                            ...
                            title='Graph will show your stats over time, against other users, and against average Americans'
                            placement="top"
                            arrow>
...
export default withStyles(styles)(GraphBtn);
